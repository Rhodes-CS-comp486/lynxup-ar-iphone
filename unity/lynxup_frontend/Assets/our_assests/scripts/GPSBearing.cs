...
public class GPSBearing : MonoBehaviour
{
    ...
    public double targetLat = 35.15;
    public double targetLon = -89.8; 
    ...
    void Update()
    {
        if (gps_ok)
        {
            ...
            if (timeDelay < 0)
            {
                ...
                int shift = 17;
                //update UI 
                arrow3d.transform.localEulerAngles = new Vector3(0, (float)(trueNorth - shift), 0);
            ...
            redarrow3d.transform.localEulerAngles = new Vector3(0, waypointDir, 0);
